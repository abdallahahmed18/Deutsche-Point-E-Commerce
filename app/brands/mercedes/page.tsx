  ...
  const categories = [
    {
      id: 1,
      name: "Engine Parts",
      image: "/images/mercengine.jpg?height=200&width=200",
      count: 95,
    ...
    },
    {
      ...
      image: "/images/mercbrake.jpg?height=200&width=200",
      count: 143,
    ...
    },
    {
      ...
      image: "/images/mercsus.jpg?height=200&width=200",
      count: 82,
    ...
    },
    {
      ...
      image: "/images/mercel.jpg?height=200&width=200",
      count: 98,
    ...
    },
    {
      id: 5,
      name: "Body & Exterior",
      image: "/images/mercbody.jpeg?height=200&width=200",
      count: 72,
    ...
    },
    {
      ...
      image: "/images/mercinter.jpg?height=200&width=200",
      count: 61,
  ...
  const popularModels = [
    {
      id: 1,
      name: "C-Class",
      image: "/images/cclass.jpeg?height=250&width=400",
    ...
    },
    {
      id: 2,
      name: "E-Class",
      image: "/images/eclass.jpeg?height=250&width=400",
    ...
    },
    {
      id: 3,
      name: "S-Class",
      image: "/images/ssc.jpg?height=250&width=400",
    ...
    },
    {
      id: 4,
      name: "GLE-Class",
      image: "/images/gle.jpeg?height=250&width=400",
      ...
      <main className="flex-1">
        ...
        <section className="relative bg-black">
          <div
            ...
            style={{ backgroundImage: "url('/images/mercsall.jpg?height=1080&width=1920')" }}
          />
              ...
              <div className="rounded-lg bg-gray-50 p-8">
                ...
                <div className="mt-6 aspect-video overflow-hidden rounded-lg bg-white shadow-sm">
                  <div
                    ...
                    style={{ backgroundImage: "url('/images/mercss.jpg?height=400&width=800')" }}
                  />
                </div>
          ...
          <section className="mt-24 rounded-lg bg-gray-50 p-8">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              <div className="relative aspect-video overflow-hidden rounded-lg">
                <Image
                  src="/images/mercor.avif?height=400&width=600"
